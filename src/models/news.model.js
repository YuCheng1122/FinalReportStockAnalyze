...
const getAllArticles = () => {
  return new Promise((resolve, reject) => {
    const sql = 'SELECT news_id,title,time,link,imageSrc,source_name,source_icon FROM googlenewsarticles'
...
const getArticlesOfToday = () => {
  return new Promise((resolve, reject) => {
    ...
    const sql = `SELECT news_id,title,time,link,imageSrc,source_name,source_icon FROM googlenewsarticles WHERE DATE(time) = ?`
